// HostManager.swift (Shared)
// Generates a random host service name each time hosting starts.
// After connecting, the host will periodically send UI state updates to the client.
// The client, upon receiving these updates, will mirror the host’s UI state.
...
final class HostManager: ObservableObject {
    ...
    private let log = Logger(subsystem: "com.infini.view.vision", category: "HostManager")
