// DeviceSelectionViewApp.swift (Non-visionOS)
import SwiftUI
import Network

struct DeviceSelectionViewApp: View {
    @EnvironmentObject var appModel: AppModel
    @EnvironmentObject var discoveryManager: DeviceDiscoveryManagerApp
    @EnvironmentObject var connectionManager: ConnectionManager
    @EnvironmentObject var pinManager: PinManagerApp
